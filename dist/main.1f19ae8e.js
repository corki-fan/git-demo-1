...
console.log("hi");
var dd = dom.create("<tr><td>我是新插入的弟弟</td></tr>");
var gg = dom.create("<tr><td>我是新插入的</td></tr>");
var ez = dom.create("<tr><td>我是新增的儿子</td></tr>");
var ba = dom.create("<div>我是新增的爸爸</div>");
console.log(dd);
...
console.log("title: ".concat(title)); //长度为2就读
...
dom.on(test, 'click', fn); //dom.remove(test, 'click',fn)
